...
/**You should use this struct via [`AsanaClient::create_goal`].

On request success, this will return a [`CreateGoalResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CreateGoalRequest {
    pub data: Option<GoalRequest>,
    pub opt_fields: Option<Vec<String>>,
    pub opt_pretty: Option<bool>,
}
impl CreateGoalRequest {}
impl FluentRequest<'_, CreateGoalRequest> {
    pub fn data(mut self, data: GoalRequest) -> Self {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, CreateGoalRequest> {
    type Output = httpclient::InMemoryResult<CreateGoalResponse>;
