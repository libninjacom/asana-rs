...
/**You should use this struct via [`AsanaClient::create_membership`].
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, CreateMembershipRequest> {
    type Output = httpclient::InMemoryResult<CreateMembershipResponse>;
