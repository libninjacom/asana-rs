...
/**You should use this struct via [`AsanaClient::create_portfolio`].

On request success, this will return a [`CreatePortfolioResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, CreatePortfolioRequest> {
    type Output = httpclient::InMemoryResult<CreatePortfolioResponse>;
