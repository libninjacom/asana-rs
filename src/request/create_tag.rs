...
/**You should use this struct via [`AsanaClient::create_tag`].

On request success, this will return a [`CreateTagResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CreateTagRequest {
    pub data: Option<TagRequest>,
    pub opt_fields: Option<Vec<String>>,
    pub opt_pretty: Option<bool>,
}
impl CreateTagRequest {}
impl FluentRequest<'_, CreateTagRequest> {
    pub fn data(mut self, data: TagRequest) -> Self {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, CreateTagRequest> {
    type Output = httpclient::InMemoryResult<CreateTagResponse>;
