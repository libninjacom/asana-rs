...
/**You should use this struct via [`AsanaClient::create_task`].

On request success, this will return a [`CreateTaskResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, CreateTaskRequest> {
    type Output = httpclient::InMemoryResult<CreateTaskResponse>;
