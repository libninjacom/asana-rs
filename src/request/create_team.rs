...
/**You should use this struct via [`AsanaClient::create_team`].

On request success, this will return a [`CreateTeamResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, CreateTeamRequest> {
    type Output = httpclient::InMemoryResult<CreateTeamResponse>;
