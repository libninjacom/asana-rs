...
/**You should use this struct via [`AsanaClient::get_team_memberships`].

On request success, this will return a [`GetTeamMembershipsResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct GetTeamMembershipsRequest {
...
impl GetTeamMembershipsRequest {}
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, GetTeamMembershipsRequest> {
    type Output = httpclient::InMemoryResult<GetTeamMembershipsResponse>;
