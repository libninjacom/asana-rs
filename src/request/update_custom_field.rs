...
/**You should use this struct via [`AsanaClient::update_custom_field`].

On request success, this will return a [`UpdateCustomFieldResponse`].*/
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, UpdateCustomFieldRequest> {
    type Output = httpclient::InMemoryResult<UpdateCustomFieldResponse>;
