...
/**You should use this struct via [`AsanaClient::update_section`].

On request success, this will return a [`UpdateSectionResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateSectionRequest {
    pub data: Option<SectionRequest>,
...
impl FluentRequest<'_, UpdateSectionRequest> {
    pub fn data(mut self, data: SectionRequest) -> Self {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, UpdateSectionRequest> {
    type Output = httpclient::InMemoryResult<UpdateSectionResponse>;
