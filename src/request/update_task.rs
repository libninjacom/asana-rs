...
/**You should use this struct via [`AsanaClient::update_task`].

On request success, this will return a [`UpdateTaskResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateTaskRequest {
    pub data: TaskRequest,
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, UpdateTaskRequest> {
    type Output = httpclient::InMemoryResult<UpdateTaskResponse>;
