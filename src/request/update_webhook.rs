...
/**You should use this struct via [`AsanaClient::update_webhook`].

On request success, this will return a [`UpdateWebhookResponse`].*/
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateWebhookRequest {
    pub data: Option<WebhookUpdateRequest>,
...
impl FluentRequest<'_, UpdateWebhookRequest> {
    pub fn data(mut self, data: WebhookUpdateRequest) -> Self {
...
impl<'a> ::std::future::IntoFuture for FluentRequest<'a, UpdateWebhookRequest> {
    type Output = httpclient::InMemoryResult<UpdateWebhookResponse>;
